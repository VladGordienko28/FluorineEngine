...
void FModelComponent::Import( CImporterBase& Im )
{
	...
	IMPORT_INTEGER( MapXSize );
	IMPORT_INTEGER( MapYSize );
	IMPORT_VECTOR( TileSize );
	IMPORT_BYTE( TilesPerU );
	IMPORT_BYTE( TilesPerV );
...
void FModelComponent::Export( CExporterBase& Ex )
{
	...
	EXPORT_INTEGER( MapXSize );
	EXPORT_INTEGER( MapYSize );
	EXPORT_VECTOR( TileSize );
	EXPORT_BYTE( TilesPerU );
	EXPORT_BYTE( TilesPerV );
...
{
	ADD_PROPERTY( MapXSize,		TYPE_Integer,	1, PROP_Editable, nullptr );
	ADD_PROPERTY( MapYSize,		TYPE_Integer,	1, PROP_Editable, nullptr );
	ADD_PROPERTY( TileSize,		TYPE_Vector,	1, PROP_Editable, nullptr );
	ADD_PROPERTY( TilesPerU,	TYPE_Byte,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( TilesPerV,	TYPE_Byte,		1, PROP_Editable, nullptr );
	...
	DECLARE_METHOD( nativeGetTile,		TYPE_Integer,	TYPE_Integer,		TYPE_Integer,	TYPE_None,		TYPE_None );
	DECLARE_METHOD( nativeSetTile,		TYPE_None,		TYPE_Integer,		TYPE_Integer,	TYPE_Integer,	TYPE_None );
	DECLARE_METHOD( nativeWorldToMap,	TYPE_Integer,	TYPE_Vector,		TYPE_None,		TYPE_None,		TYPE_None );
