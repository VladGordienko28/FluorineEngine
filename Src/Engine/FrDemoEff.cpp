...
//
// Effect bitmap import.
//
void FDemoBitmap::Import( CImporterBase& Im )
{
	FBitmap::Import( Im );
	IMPORT_OBJECT( PaletteRef );
}


//
// Effect bitmap export.
//
void FDemoBitmap::Export( CExporterBase& Ex )
{
	FBitmap::Export( Ex );
	EXPORT_OBJECT( PaletteRef );
}
...
//
DWord FDemoBitmap::GetBlockSize()
{
	// 8-Bits image.
...
// Import the plasma.
//
void FPlasmaBitmap::Import( CImporterBase& Im )
{
	FDemoBitmap::Import( Im );
	IMPORT_FLOAT( PlasmaA );
	IMPORT_FLOAT( PlasmaB );
	IMPORT_FLOAT( PlasmaC );
	IMPORT_FLOAT( PlasmaD );
}
...
// Export the plasma.
//
void FPlasmaBitmap::Export( CExporterBase& Ex )
{
	FDemoBitmap::Export( Ex );
	EXPORT_FLOAT( PlasmaA );
	EXPORT_FLOAT( PlasmaB );
	EXPORT_FLOAT( PlasmaC );
	EXPORT_FLOAT( PlasmaD );
...
{
	FDemoBitmap::Import( Im );
	IMPORT_BYTE(Direction);
	IMPORT_BYTE(WaveAmpl);
	IMPORT_BYTE(WaveFreq);
	IMPORT_OBJECT(Image);
	IMPORT_BYTE(VOffset);
	IMPORT_BYTE(HOffset);
}
...
{
	FDemoBitmap::Export( Ex );
	EXPORT_BYTE(Direction);
	EXPORT_BYTE(WaveAmpl);
	EXPORT_BYTE(WaveFreq);
	EXPORT_OBJECT(Image);
	EXPORT_BYTE(VOffset);
	EXPORT_BYTE(HOffset);
}
...
{
	ADD_PROPERTY( PlasmaA,		TYPE_Float,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( PlasmaB,		TYPE_Float,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( PlasmaC,		TYPE_Float,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( PlasmaD,		TYPE_Float,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( PaletteRef,	TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	return 0;
}
...
REGISTER_CLASS_CPP( FFireBitmap, FDemoBitmap, CLASS_None )
{
	...
	ADD_PROPERTY( bRising,		TYPE_Bool,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( FireHeat,		TYPE_Byte,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( PaletteRef,	TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	return 0;
}
...
REGISTER_CLASS_CPP( FWaterBitmap, FDemoBitmap, CLASS_None )
{
	...
	ADD_PROPERTY( WaterAmpl,	TYPE_Byte,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( Image,		TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	return 0;
}
...
{
	ADD_PROPERTY( bMoveGlass,	TYPE_Bool,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( Glass,		TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	ADD_PROPERTY( Image,		TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	ADD_PROPERTY( HSpeed,		TYPE_Float,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( VSpeed,		TYPE_Float,		1, PROP_Editable, nullptr );
	return 0;
}
...
REGISTER_CLASS_CPP( FHarmonicBitmap, FDemoBitmap, CLASS_None )
{
	...
	ADD_PROPERTY( Direction,	TYPE_Byte,		1, PROP_Editable, _EWaveDirection );
	ADD_PROPERTY( Image,		TYPE_Resource,	1, PROP_Editable, FBitmap::MetaClass );
	ADD_PROPERTY( WaveAmpl,		TYPE_Byte,		1, PROP_Editable, nullptr );
	ADD_PROPERTY( WaveFreq,		TYPE_Byte,		1, PROP_Editable, nullptr );
	return 0;
}
